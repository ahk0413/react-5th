...
function AvatarPage() {
    return (React.createElement("ul", { className: "avatarList" },
        React.createElement(Avatar, { name: "MaengGoo", status: "offline" }),
        React.createElement(Avatar, { name: "JjangGoo", status: "dont-disturb" }),
        React.createElement(Avatar, { name: "YooRi", status: "away" }),
        React.createElement(Avatar, { name: "JjangAh", status: "online" }),
        React.createElement(Avatar, { name: "HyungMan", status: "online" })));
}
